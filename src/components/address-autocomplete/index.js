...
const GooglePlacesAutocomplete = createReactClass({
        ...
        if (request.status === 200) {
          ...
          if (responseJSON.status === 'OK') {
            if (this.isMounted()) {
              ...
              this._onBlur();
              this.setState({
                text: rowData.structured_formatting.main_text,
              });
  ...
  render() {
    ...
    let {text} = this.state
    if (this.props.override && this.props.override !== text && !this.state.listViewDisplayed) {
      text = this.props.override
    }
    return (
      <View
        style={[defaultStyles.container, this.props.styles.container, { zIndex: 5 }]}
      >
        <View
        ...
        >
          <TextInput
            ...
            accessoryView={this.props.accessoryView}
